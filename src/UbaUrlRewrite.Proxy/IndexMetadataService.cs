// <copyright file="IndexMetadataService.cs" company="Spatial Focus GmbH">
...
public class IndexMetadataService
{
	...
	public IndexMetadataService(IServiceProvider serviceProvider, IOptions<IndexMetadataOptions> options, ILogger<IndexMetadataOptions> logger)
	{
	...
	{
		this.logger.LogInformation("Clearing database");

		await this.serviceProvider.CreateScope().ServiceProvider.GetRequiredService<RewriteDbContext>().Database.EnsureDeletedAsync(cancellationToken);
